...
class CRFA_Stage1(nn.Module):
    ...
    def word_attention(self, input_sentences):
        ...
        # print("u-------", u.shape)       # torch.Size([64, 13, 1])
        ...
        # print("alpha1-------", alpha1.shape)   # torch.Size([64, 1, 13])
...
# ------------------------------------------------------------
        ...
        A = torch.cat((output_begin, cpt_output_begin), -1)
        # print("A-----", A.shape)     A----- torch.Size([64, 768])
        logits = self.fc(A)
